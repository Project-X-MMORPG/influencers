package dev.jaqobb.influencers.api.rank.type;

import dev.jaqobb.influencers.api.rank.Rank;
...
import dev.jaqobb.influencers.api.util.common.StringHelper;
...
public class YouTubeRank extends Rank {
	...
	public boolean meetRequirements(Channel channel) {
