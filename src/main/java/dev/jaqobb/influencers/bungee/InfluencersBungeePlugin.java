...
public class InfluencersBungeePlugin extends Plugin implements InfluencersPlugin {
	...
	public void onEnable() {
		...
		this.getProxy().getPluginManager().registerCommand(this, new InfluencersCommand(this));
